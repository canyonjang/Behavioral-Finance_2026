...
QUIZ_DATA = [
    {"q": "1. 쌍곡형 할인으로 설명할 수 없는 시간적 비정합성을 훌륭하게 설명하는 이론은 무엇인가?", "a": "시간해석이론"},
    {"q": "2. 시간적으로 멀리 있는 대상에 대해서는 추상적, 본질적, 핵심적인 점에 착안해 (상위/하위) 수준의 해석을 한다. (상위와 하위 중 맞는 것을 적으세요)", "a": "상위"},
    {"q": "3. 심리적 거리 중 (_________) 거리가 대표적이다.", "a": "시간적"},
    {"q": "4. 심리적 거리 중 (__________) 거리는 나와 타인, 혹은 내 집단과 외 집단 간의 거리를 의미한다.", "a": "사회적"},
    {"q": "5. 실험 설계에서 피험자가 여러 개의 처치(treatment)를 연속해서 받을 때, 무엇을 먼저 했느냐가 종속 변수(결과)에 왜곡을 주는 현상은 무엇인가?", "a": "순서 효과"},
    {"q": "6. 연구 결과에 따르면, 30대 소비자의 경우, 실제 연령과 인지적 연령 간의 차이를 상기한 소비자는 (상위/하위) 해석수준의 광고 메시지를 접했을 때 제품 구매의도가 더 높게 나타났다. . (상위와 하위 중 맞는 것을 적으세요)", "a": "하위"},
    {"q": "7. 여성이 남성보다 자기과신 성향이 강하고, 남성이 여성보다 자주 거래한다. (이 문장이 맞았는지 틀렸는지, 맞음과 틀림 중 하나를 적으세요)", "a": "틀림"}
]
