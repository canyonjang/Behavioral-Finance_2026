...
QUIZ_DATA = [
    {"q": "1. 봉투 시스템은 돈에는 꼬리표가 없다는 경제학 원칙인 돈의 (____________)을 위반하는 것이다.", "a": "대체가능성"},
    {"q": "2. 재산도 다양한 심리 계좌로 구분되는데, 지출하기 가장 쉬운 형태의 재산은 (_________)이다.", "a": "현금"},
    {"q": "3. 아담 스미스는 자기통제를 (________)과 공평한 관찰자의 투쟁 또는 충돌로 설명하였다.", "a": "열정"},
    {"q": "4. 자기통제는 현재와 미래 사이의 선택, 즉 (_____________) 선택에 대한 문제이다.", "a": "시점 간"},
    {"q": "5. 현재가치를 미래가치로 바꿀 때는 (___________)이, 미래가치를 현재가치로 바꿀 때는 (___________)이 필요하다.", "a": "이자율, 할인율"},
    {"q": "6. 할인율을 일관되게 적용하는 것을 (___________) 할인이라 한다.", "a": "지수형"},
    {"q": "7. 할인율이 클수록 인내심이 부족하고 미래가치를 높게 평가한다는 의미이다. (맞음 또는 틀림 중 하나로 답하세요)", "a": "틀림"}
]
