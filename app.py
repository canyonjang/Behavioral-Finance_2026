...
QUIZ_DATA = [
    {"q": "1. 주식투자를 소위 대박(jackpot)의 기회로 인식하는 경향과 관련된 복권형(lottery-type) 주식을 선호하는 투자자들은 분산투자 수준이 높고, 거래빈도도 높다. (이 설명에 대해 맞음/틀림 중 하나를 적으세요)", "a": "틀림"},
    {"q": "2. 매수가격에 비해 가격이 상승한 주식은 매도하여 이익을 실현하고, 매수가격에 비해 가격이 하락한 주식은 매도를 미루고 보유하는 현상은 무엇인가?", "a": "처분효과"},
    {"q": "3. 개인투자자 중에서도 투자역량과 투자경험이 부족할수록 처분효과가 (약하다/강하다). (둘 중에 맞는 것을 적으세요)", "a": "강하다"},
    {"q": "4. 처분효과는, 손실을 실현하지 않음으로써 의사결정 실수를 인정하는데 따르는 심리적 불편함을 회피하고, 이익을 실현함으로써 (_________)을 얻고자 하는데서 나타나는 현상이다.", "a": "만족감"},
    {"q": "5. 투자 의사결정에 대한 (자신의) 개입 정도가 낮을수록 처분효과가 (낮게/높게) 나타난다. (둘 중에 맞는 것을 적으세요)", "a": "낮게"},
    {"q": "6. 일반적으로 (작위/부작위) 후회가 더 큰 고통을 느끼게 한다. (둘 중에 맞는 것을 적으세요)", "a": "작위"},
    {"q": "7. Kaustia(2010)에 따르면, 어떤 종목의 이익 규모가 클수록 그 종목을 매도할 경향이 (약했다/강했다). (둘 중에 맞는 것을 적으세요)", "a": "강했다"}
]
