...
QUIZ_DATA = [
    {"q": "1. 경제학의 핵심 가정은 사람들이 (_____________) 작업을 거쳐 선택한다는 것이다.", "a": "최적화"},
    {"q": "2. 탈러는 애덤 스미스의 보이지 않는 손 대신에 보이지 않는 (__________)를 주장했다.", "a": "속임수"},
    {"q": "3. 효용, 이기심, 효율, 경쟁 등을 중요시하는 경제학(표준이론)과 달리, 행동경제학이 사람들이 관심을 갖는 가치라고 내세우는 것은?", "a": "공정성"},
    {"q": "4. 공공재의 두 가지 특성은?", "a": "비경합성, 비배제성"},
    {"q": "5. (___________) 이론은 주식 투자자들의 군집 행동을 보여준다.", "a": "칵테일파티"},
    {"q": "6. 두 체계 이론에서 감성, 직관, 본능, 습관 등과 관련이 깊고, 휴리스틱과 바이어스를 포함하는 것은?", "a": "1체계"},
    {"q": "7. 표준이론의 효용함수에 해당하는 행동경제학의 개념은?", "a": "가치함수"}
]
